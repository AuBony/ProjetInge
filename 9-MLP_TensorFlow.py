...
def generate_dataset(num_samples, test_size=0.33):
    ...
    # ouputs array([[0.3],[0.4]])
    y = np.array([[i[0] + i[1]] for i in x])

    # split dataset into test and training sets (sklearn.model_selection)
...
if __name__ == "__main__":
    ...
    # keras = library of models
    model = tf.keras.models.Sequential([
        # Dense layer connects all the neurones from previous layer to current layer
