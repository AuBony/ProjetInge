...
IIB3_y_train <- as.factor(c(croc_train$event, no_event_train$event))
IIB3_x_train <- rbind.data.frame(croc_train[, 5:20], no_event_train[, 5:20])

IIB3_y_test <- as.factor((c(croc_test$event, no_event_test$event)))
IIB3_x_test <- rbind.data.frame(croc_test[, 5:20], no_event_test[, 5:20])
