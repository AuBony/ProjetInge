...
##        Here we will carry out the process for both types of labelling. 
##        Labelling 1 : the entire break sound is labelled
##        Labelling 2 : Characteristic parts of the break are labelled 
...
# Labellisation 1
data_path_1 <- "data/labels/labels_1/"
...
remove(data_1, data_modif_1, data_modif_chat_kibble_duration_1, df_txt_1)

# Labellisation 2
data_path_2 <- "data/labels/labels_1/"
...
remove(data_2, data_modif_2, data_modif_chat_kibble_duration_2, df_txt_2)
...
# Number of frames per sampling method 
